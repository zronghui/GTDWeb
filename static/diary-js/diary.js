$(document).ready(function () {
    let i;
	var totalEditorsNumbers = 6;
    var current_id = 3;
    var modify_status = false;

    var txtEditors = ["#txtEditor0", "#txtEditor1", "#txtEditor2", "#txtEditor3", "#txtEditor4", "#txtEditor5"];
    var toggles = ["#toggle0", "#toggle1", "#toggle2", "#toggle3", "#toggle4", "#toggle5"];
    var firstFocus = [true, true, true, true, true, true, true, true, true];

    var svgs = ["#t_svg", "#y_svg", "#m_svg", "#w_svg"];
    var svg_counts = ["#t_count", "#y_count", "#m_count", "#w_count"];
    ...
    // ----------------------------------------------For editors---------------------------------------
    // Create editors
    for (i = 0; i < totalEditorsNumbers; i++) {
        $(txtEditors[i]).Editor();
    }
